...
default.register_solid_rock("default:my_stone", {
  ...
  groups_solid_stone={dry={firmness=3,resilience=3,cavein=25,absorbing_power=10,capillarity=90,erosion_air=10},
                      damp={firmness=3,resilience=2,cavein=35,absorbing_power=11,capillarity=95,desiccation=6},
                      wet={firmness=3,resilience=1,cavein=45,absorbing_power=12,capillarity=95,desiccation=8},
                      soggy={firmness=2,resilience=1, cavein=55,desiccation=10}},
  groups_big_stones={dry={landslide=75,absorbing_power=80},
                      damp={landslide=80,absorbing_power=84,desiccation=25},
                      wet={landslide=85,absorbing_power=88,desiccation=75},
                      soggy={landslide=90,desiccation=85}},
  groups_medium_stones={dry={landslide=90,absorbing_power=85},
                      damp={landslide=93,absorbing_power=89,desiccation=30},
                      wet={landslide=96,absorbing_power=93,desiccation=70},
                      soggy={landslide=99,desiccation=75}},
})
...
minetest.register_alias("default:salt_water_source","default:water_source");
minetest.register_alias("default:salt_water_flowing","default:water_flowing");
...
minetest.register_alias("default:fresh_water_source","default:river_water_source");
minetest.register_alias("default:fresh_water_flowing","default:river_water_flowing");

minetest.register_node("default:spring_water_source", {
	description = S("Spring Water Source"),
	drawtype = "liquid",
	tiles = {
		{
			name = "default_river_water_source_animated.png",
